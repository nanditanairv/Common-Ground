...
function UploadModal({ onClose, onSubmitted, onOtpVerified }: { onClose: () => void; onSubmitted: (reference: string) => void; onOtpVerified: () => void }) {
  ...
  useEffect(() => {
    ...
    const redirectTimer = window.setTimeout(onOtpVerified, 1100);
    return () => window.clearTimeout(redirectTimer);
  }, [onOtpVerified, otpSuccess]);
